...
import com.example.tracker.viewmodels.RegisterViewModel
...
fun RegisterScreen(
    ...
    Scaffold(
        ...
        Box(
            ...
            // Register Form Content inside a Card
            Column(
                modifier = Modifier
                    .fillMaxSize()
                ...
                // Overlap: Spacer pushes the card down to 22% height for more space
